...
namespace P_Test
{
    ...
    public class TestValidation
    {
        ...
        {
            var actual = Validations.IsValidEmailId(EmailId);
        ...
        {
            var actual = Validations.IsContactNumberValid(Contact_Number);
        ...
        {
            var actual = Validations.IsGenderValid(Gender);
        ...
        {
            var actual = Validations.IsValidPassword(Password);
        ...
        {
            var actual = Validations.IsValidSProfile(SProfile);
