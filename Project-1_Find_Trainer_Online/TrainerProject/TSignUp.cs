...
namespace TrainerProject
{
    internal class TSignUp : IMenu
    {
        ...
        public void Display()
         {
            Log.Logger.Information("This is a sign up page");
            ...
            System.Console.WriteLine("[9] SocialMedia_Profile      : " + details.SocialMedia_Profile);
        ...
        public string UserChoice()
        {
            ...
            Log.Logger.Information("Selecting User Choice");
            ...
            switch (userchoice)
            {
                ...
                case "9":
                    System.Console.Write("Enter you SocialMedia_Profile: ");
